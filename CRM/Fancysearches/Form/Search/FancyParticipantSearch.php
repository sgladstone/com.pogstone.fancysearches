 ...
 */
class CRM_Fancysearches_Form_Search_FancyParticipantSearch extends CRM_Contact_Form_Search_Custom_Base implements CRM_Contact_Form_Search_Interface {
...
";
	...
	$counted_select = $form->add( 'select',
         ...
         */
          ...
          if(count($this->_allChosenEvents ) > 0 ){
          	$form->assign( 'elements', array(   'event_id', 'lineitem_id',  'layout_choice' , 'counted_choice',  'start_date', 'end_date',  'age_date',  'user_columns_to_display' ) );
          }else{
         	$form->assign( 'elements', array(   'event_id', 'layout_choice' , 'counted_choice',  'start_date', 'end_date', 'age_date',  'user_columns_to_display' ) );
